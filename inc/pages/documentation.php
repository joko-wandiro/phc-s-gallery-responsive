...
?>
	...
	">
	<input type="image" src="<?php echo PHC_S_GALLERY_RESPONSIVE_BANNER . "banner_donation.png"; ?>" border="0" name="submit" 
	alt="Help me with your Donation !">
	<img alt="" border="0" src="https://www.paypalobjects.com/id_ID/i/scr/pixel.gif" width="1" height="1">
	</form>
	</li>
	<li class="or"><img src="<?php echo PHC_S_GALLERY_RESPONSIVE_BANNER . "banner_or.png"; ?>" /></li>
	<li><a href="http://www.opencart.com/index.php?route=extension/extension&filter_username=phantasmacode"><img src="<?php echo PHC_S_GALLERY_RESPONSIVE_BANNER . "banner_opencart.png"; ?>" /></a></li>
	</ul>
	<!-- End Banner -->
	...
	<li>
	<p><?php _e("Use Widget Text. Enter Title. Ex: S Gallery Responsive Widget. Then add shortcode for widget into content / textarea.", PHC_S_GALLERY_RESPONSIVE_IDENTIFIER); ?></p>
	<p>
